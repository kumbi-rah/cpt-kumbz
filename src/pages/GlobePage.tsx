        ...
        <div className="px-5 pb-4">
          <div className="flex justify-around bg-card rounded-xl border py-3 md:py-5">
            <div className="text-center">
              <p className="font-georgia text-xl md:text-2xl font-bold text-amber">{trips.length}</p>
              <p className="text-[9px] md:text-xs text-muted-foreground uppercase tracking-wider">Trips</p>
            </div>
            <div className="w-px bg-border" />
            <div className="text-center">
              <p className="font-georgia text-xl md:text-2xl font-bold text-teal">{countries}</p>
              <p className="text-[9px] md:text-xs text-muted-foreground uppercase tracking-wider">Countries</p>
            </div>
            <div className="w-px bg-border" />
            <div className="text-center">
              <p className="font-georgia text-xl md:text-2xl font-bold text-amber">{miles.toLocaleString()}</p>
